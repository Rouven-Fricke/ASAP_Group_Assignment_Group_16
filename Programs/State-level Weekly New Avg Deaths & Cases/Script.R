...
colnames(Ncases_Ndeaths) <- c("Code", "Week", "AvgNCases", "AvgNDeaths")
...
write.csv(NCases_NDeaths,"/users/hansmarshall/Desktop/ASP/Group Assignment/Data//NCases_NDeaths.csv", row.names = FALSE)
